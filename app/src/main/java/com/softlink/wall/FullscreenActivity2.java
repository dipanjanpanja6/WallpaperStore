...
public class FullscreenActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        key=getIntent().getExtras().get("key2").toString();
        ...
        if (User == null) {
            Intent intent = new Intent(FullscreenActivity2.this, LogInActivity.class);
            ...
            shere.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(FullscreenActivity2.this, "Getting things ready....", Toast.LENGTH_SHORT).show();
            ...
            Picasso.get().load(link).into(new Target() {
                ...
                public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                    ...
                    try {
                        ...
                        ChocoBar.builder().setActivity(FullscreenActivity2.this)
            ...
            Picasso.get().load(link).into(new Target() {
                ...
                public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                    ...
                    try {
                        ...
                        output.flush();
                        output.close();
                        Uri uri = FileProvider.getUriForFile(FullscreenActivity2.this, "com.codepath.fileprovider", file);
